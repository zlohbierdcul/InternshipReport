...
\subsection[A6 - Eingabefelder der Seite zum Aktualisieren des Projektowners und der Käufergruppe]{A6 - Eingabefelder der Seite zum Aktualisieren des Projektowners und der Käufergruppe}

\begin{center}
    \begin{tabular}{ |p{0.2\linewidth}|p{0.8\linewidth}| } 
        \hline
        \rowcolor{lightgray}
        \textbf{A6} & \textbf{Eingabefelder der Seite zum Aktualisieren des Projektowners und der Käufergruppe} \\
        \hline
        ...
        \hline
    \end{tabular}
    \captionof{table}{Anforderung A6 - Eingabefelder der Seite zum Aktualisieren des Projektowners und der Käufergruppe \label{Tab:Tcr}}
\end{center}
