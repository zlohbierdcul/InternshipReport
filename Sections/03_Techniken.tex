...
\begin{itemize}
    ...
    \item \textbf{Verbesserte \acs{ide}-Unterstützung:} \\    Die Entwicklungsumgebung wird von TypeScript durch eine Autovervollständigung, Refactoring-Tools und IntelliSense erheblich verbessert. \cite{typescript_in_vscode}
...
\begin{itemize}
    ...
    \end{lstlisting}
    \item \textbf{Klassen:} \\
    TypeScript unterstützt objektorientierte Programmierung durch Klassen, was Vererbung, Kapselung und andere \acs{oop}-Konzepte ermöglicht.
...
\subsubsection[Das \acs{sapui5} Framework]{Das \acs{sapui5} Framework}
\acs{sapui5} ist ein auf JavaScript basierendes UI-Framework, um plattformübergreifende Webanwendungen für Unternehmen effizient zu entwickeln.
...
\subsubsection[Grundlegende Architektur von \acs{sapui5}]{Grundlegende Architektur von \acs{sapui5}}
\acs{sapui5} basiert auf der Model-View-Controller (MVC) Architektur, ein gängiges Entwurfsmuster, welches eine klare Trennung der verschiedenen Anwendungskomponenten gewährleistet:
\begin{itemize}
    \item \textbf{Model:} \\
    ...
    \item \textbf{View:} \\
    Die View beschreibt das Layout und Design der Benutzeroberfläche. \acs{sapui5} bietet verschiedene Ansätze für die Definition der Views, darunter XML, HTML, JSON und JavaScript.
...
\subsubsection[Vorteile und Schlüsselmerkmale von \acs{sapui5}]{Vorteile und Schlüsselmerkmale von \acs{sapui5}}
\acs{sapui5} bietet eine Reihe von Vroteilen und Funktionen, die es zu einem leistungsstarken Framework für die Entwicklung von Unternehmensanwendungen machen:

\begin{itemize}
    \item \textbf{Responsive Design:} \\
    Durch \acs{sapui5} werden Anwendungen automatisch an verschiedene Bildschirmgrößen angepasst, wodurch sie auf Desktop-Computern und mobilen Geräten gut funktionieren.
    ...
    Mit \acs{sapui5} können Anwendung mithilfe des sogenannten i18n-Models an verschiedene Sprachen und Regionen angepasst werden. 
...
\subsubsection[\acs{sapui5} in Verbindung mit TypeScript]{\acs{sapui5} in Verbindung mit TypeScript}
\acs{sapui5} in TypeScript ist eine relativ neue Erweiterung zu \acs{sapui5}, die 2021 von SAP veröffentlicht wurde und immer weiter verbessert wird.
Es bringt alle Vorteile die TypeScript gegenüber JavaScript mitbringt zu \acs{sapui5}, was die Entwicklung der Anwendungen stark verbessert.

\subsubsection[Unterschied zwischen JavaScript und TypeScript in \acs{sapui5} anhand eines Beispiels]{Unterschied zwischen JavaScript und TypeScript in \acs{sapui5} anhand eines Beispiels}
Im Folgenden werden die Unterschiede eines \acs{sapui5} BaseControllers in JavaScript und TypeScript gezeigt. 

\textbf{JavaScript:} \\
In JavaScript werden \acs{sapui5} Controller über eine interne Funktion definiert. 
...
Damit der TypeScript Kompiller die Klasse jedoch in einen \acs{sapui5} Controller konvertieren kann, muss ein Kommentar mit dem passenden namespace hinzugefügt werden.
