...
\lstdefinelanguage{JavaScript}{
  keywords={typeof, new, true, false, catch, try, function, return, null, catch, switch, var, if, in, while, do, else, case, break, interface, log, let, const, class, import, from, export, extends, public, private},
...
\include{TemplateElements/TitelPage}
...
\pagestyle{plain}
\include{TemplateElements/Sichtvermerk}
...
\include{Chapters/01_Umfeldbeschreibung}
\include{Chapters/02_Wochenberichte}
\include{Chapters/03_Projektbericht}
